...
<div>
<h1 className=" font-bold tracking-tighter uppercase px-9 text-8xl leading-[5.5vw]">
            Eye- <br /> Opening
</h1>
</div>
...
<div>
<h1 className=" font-bold tracking-tighter uppercase px-1 text-8xl leading-[5.5vw]">
           presentations
</h1>
...
<div className=" py-11 mt-10">
        ...
        <div className=" py-56 mt-10 ml-auto px-4">
        <a className="block text-xl font-light" href="">
            Home
          </a>
          <a className="block text-xl font-light" href="">
...
<div className='mr-[700px] absolute bottom-11 px-11 '>
